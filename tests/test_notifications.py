...
class TestNotificationCreation:
    ...
    def test_match_creates_notification(
        self, client, app, user_with_profile, second_user_with_profile
    ):
...
class TestMarkNotificationRead:
    ...
    def test_mark_notification_read_unauthorized(
        self, client, app, user_with_profile, second_user_with_profile
    ):
        ...
        with app.app_context():
            ...
            if notification:
                response = client.put(
                    ...
                    headers={
                        "Authorization": f'Bearer {second_user_with_profile["token"]}'
                    },
                )
                assert response.status_code == 200
...
class TestNotificationData:
    ...
    def test_notification_includes_sender_profile(
        self, client, app, user_with_profile, second_user_with_profile
    ):
