...
class TestLikeUser:
    ...
    def test_like_user_success(self, client, user_with_profile, second_user_with_profile):
        """User should be able to like another user."""
        response = client.post(f'/api/matches/like/{second_user_with_profile["user_id"]}',
    ...
    def test_like_user_creates_notification(self, client, app, user_with_profile, second_user_with_profile, mock_socket_emit):
    ...
    def test_like_user_websocket_emitted(self, client, user_with_profile, second_user_with_profile, mock_socket_emit):
    ...
    def test_like_self_forbidden(self, client, user_with_profile):
        ...
        response = client.post(f'/api/matches/like/{user_with_profile["user_id"]}',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
    ...
    def test_like_nonexistent_user(self, client, user_with_profile):
        ...
        response = client.post('/api/matches/like/99999',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
    ...
    def test_like_twice_same_user(self, client, user_with_profile, second_user_with_profile):
...
class TestDislikeUser:
    ...
    def test_dislike_user_success(self, client, user_with_profile, second_user_with_profile):
        """User should be able to dislike another user."""
        response = client.post(f'/api/matches/dislike/{second_user_with_profile["user_id"]}',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
    ...
    def test_dislike_nonexistent_user(self, client, user_with_profile):
        ...
        response = client.post('/api/matches/dislike/99999',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
...
class TestPassUser:
    ...
    def test_pass_user_success(self, client, user_with_profile, second_user_with_profile):
        """User should be able to pass on another user."""
        response = client.post(f'/api/matches/pass/{second_user_with_profile["user_id"]}',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
    ...
    def test_pass_nonexistent_user(self, client, user_with_profile):
        ...
        response = client.post('/api/matches/pass/99999',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
...
class TestMutualMatch:
    ...
    def test_mutual_match_creation(self, client, app, user_with_profile, second_user_with_profile):
        ...
        with app.app_context():
            ...
            match = Match.query.filter(
                ((Match.user1_id == user_with_profile['user_id']) & (Match.user2_id == second_user_with_profile['user_id'])) |
                ((Match.user1_id == second_user_with_profile['user_id']) & (Match.user2_id == user_with_profile['user_id']))
            ).first()
            assert match is not None
    
    def test_mutual_match_notification(self, client, app, user_with_profile, second_user_with_profile, mock_socket_emit):
    ...
    def test_mutual_match_websocket(self, client, app, user_with_profile, second_user_with_profile, mock_socket_emit):
...
class TestLikeAfterMatch:
    ...
    def test_like_after_match_still_works(self, client, match_pair, third_user_with_profile):
        """User should still be able to like after being matched."""
        response = client.post(f'/api/matches/like/{third_user_with_profile["user_id"]}',
    ...
    def test_already_matched_users_can_like(self, client, app, match_pair):
        ...
        response = client.post(f'/api/matches/like/{match_pair["user2"]["user_id"]}',
            headers={'Authorization': f'Bearer {match_pair["user1"]["token"]}'}
        )
