...
class TestSearch:
    ...
    def test_search_by_age_range(self, client, user_with_profile, second_user_with_profile):
    ...
    def test_search_by_interests(self, client, user_with_profile, second_user_with_profile):
...
class TestBookmarks:
    ...
    def test_add_duplicate_bookmark(self, client, user_with_profile, second_user_with_profile):
        """Should handle duplicate bookmarks gracefully."""
        # Add bookmark first time
        client.post(f'/api/matches/bookmark/{second_user_with_profile["user_id"]}',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
    ...
    def test_remove_bookmark(self, client, user_with_profile, second_user_with_profile):
        ...
        # Remove bookmark
        response = client.delete(f'/api/matches/bookmark/{second_user_with_profile["user_id"]}',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
        assert response.status_code == 200

    def test_remove_nonexistent_bookmark(self, client, user_with_profile, second_user_with_profile):
...
class TestSearchFilters:
    ...
    def test_filter_by_gender(self, client, user_with_profile, second_user_with_profile):
    ...
    def test_filter_by_multiple_criteria(self, client, user_with_profile, second_user_with_profile):
    ...
    def test_search_includes_bookmark_status(self, client, user_with_profile, second_user_with_profile):
