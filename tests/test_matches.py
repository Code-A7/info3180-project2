...
class TestGetPotentialMatches:
    ...
    def test_get_potential_matches_success(self, client, user_with_profile, second_user_with_profile):
    ...
    def test_get_potential_matches_excludes_liked_users(self, client, user_with_profile, second_user_with_profile):
...
class TestMatchScore:
    ...
    def test_get_match_score(self, client, user_with_profile, second_user_with_profile):
        ...
        response = client.get(f'/api/matches/score/{second_user_with_profile["user_id"]}',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
    ...
    def test_get_match_score_self(self, client, user_with_profile):
        ...
        response = client.get(f'/api/matches/score/{user_with_profile["user_id"]}',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
        
        assert response.status_code in [200, 400]
    
    def test_match_score_includes_details(self, client, user_with_profile, second_user_with_profile):
...
class TestMatchFilters:
    ...
    def test_filter_by_age_min(self, client, user_with_profile, second_user_with_profile):
        """Should filter by minimum age."""
        response = client.get('/api/matches/potential?age_min=30',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
    ...
    def test_filter_by_age_max(self, client, user_with_profile, second_user_with_profile):
        """Should filter by maximum age."""
        response = client.get('/api/matches/potential?age_max=20',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
    ...
    def test_filter_by_interests(self, client, user_with_profile, second_user_with_profile):
        """Should filter by shared interests."""
        response = client.get('/api/matches/potential?interests=coding',
            headers={'Authorization': f'Bearer {user_with_profile["token"]}'}
        )
...
class TestMatchAlgorithm:
    ...
    def test_match_score_with_compatible_age(self, client, user_with_profile, second_user_with_profile):
    ...
    def test_match_score_with_shared_interests(self, client, user_with_profile, second_user_with_profile):
    ...
    def test_match_score_with_matching_goal(self, client, user_with_profile, second_user_with_profile):
    ...
    def test_match_score_gender_preference(self, client, user_with_profile, second_user_with_profile):
